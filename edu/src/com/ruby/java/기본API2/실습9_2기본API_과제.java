...
//
//=======
package com.ruby.java.기본API2;

//3단계 문제1: 9장 기본API 실습과제에서 Library 에 있는 Book[] books 를  ArrayList 버전으로 변경해서 구현하세요.
...
// Library 클래스 //Library 에 있는 Book[] books 를  ArrayList 버전으로 변경해서 구현하세요.
...
//	private int top = 0;
	...
	public void printBooks(String msg) {
		...
		for(int i = 0; i<books.size(); i++) {
			System.out.println(books.get(i).toString());//toString()호출
		}
	}
...
public class 실습9_2기본API_과제 {
	public static void main(String[] args) {
		...
		// 도서 목록 출력
		System.out.println("제목정렬전 도서숫자="+ library.books);
		library.printBooks("\n제목정렬전");
		...
		// 정렬된 도서 목록 출력
		System.out.println("제목정렬후 도서숫자 = " + library.books);
		library.printBooks("\n제목정렬후");

		// 특정 제목으로 도서 검색
		System.out.println("ISBN정렬전 도서숫자 = " + library.books);
		library.printBooks("\nISBN정렬전");
		...
		// 정렬된 도서 목록 출력
		System.out.println("ISBN정렬후 도서숫자 = " + library.books);
		library.printBooks("\nISBN정렬후");
