...
//인터페이스 구현 문법: class 클래스이름 implements 인터페이스이름 { ... }
...
class FruitName implements Comparator<Fruit4>{}//과일 이름으로 비교
class FruitPrice implements Comparator<Fruit4>{}//과일 가격으로 비교 ~하는 비교연산(클래스,FruitName FruitPrice)을 만든다는 의미
...
public class Test_실습3_7객체배열이진탐색 {
	...
	public static void main(String[] args) {
		...
		Fruit4[] arr = {new Fruit4("사과", 200, "2023-5-8"), //유효기간
		...
		FruitName cc = new FruitName();//비교연산자 cc
